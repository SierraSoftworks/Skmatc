...
Validator.create = Validator.module = function(handles, validate, options) {
...
Validator.prototype.assert = function(schema, data, path, test, message) {
    ...
    if(!test) return this.fail(schema, data, path, message);
};
...
Validator.prototype.fail = function(schema, data, path, message) {
    ...
    return new Failure(this, schema, data, path, message);
};