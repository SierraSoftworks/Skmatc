...
Result.prototype = {
    ...
    get message() {
        ...
        return this.failures.map(function(failure) { return failure.message; }).join('\n');
    },

    get messages() {
        return this.failures.map(function(failure) { return failure.message; });
    },
    ...
    get error() {
        ...
        e.messages = this.failures.map(function(failure) { return failure.message; });
